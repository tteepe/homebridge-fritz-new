    ...
    async makeRequest(command, ain, options = {}) {
        ...
        return this.queueCommand(async () => {
            try {
                ...
                // Methods without an AIN take options as their 2nd parameter
                const noAinMethods = ['getDeviceList', 'getSwitchList', 'getThermostatList', 'getOSVersion', 'getGuestWlan'];
                if (noAinMethods.includes(methodName)) {
